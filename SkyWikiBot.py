...
def handle_text(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, 'Ваш запрос слишком короткий или имеет множество значений (или не имеет вовсе). Пожалуйста, замените его на синоним или используйте другой запрос.')
